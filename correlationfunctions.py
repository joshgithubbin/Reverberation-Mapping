...
def crosscorrelate(a1,a2,lrange,step,fc):
    """introduces lag to a data set a1 and cross-correlates that lagged set with another a2. lrange equals half the range of the induced lag in either direction.
    step is the step of the lag range. fc is the column containing the flux of the set (see readme)."""
